  ...
  return (
    <div className="mx-14 xl:mx-56">
      ...
      <p className="tracking-wide mt-8">
        ...
        computer science degree. Every day brings a new challenge, a new
        project, and a chance to unleash my creativity. For me, coding isn't
        just about the technical aspects; it's about the thrill of
        accomplishment and the endless possibilities for innovation.
      </p>
    </div>
  );
}
