...
function Card({title, name, date, duration, link, img, ...otherProps}) {
    return (
        <div className="h-[max] cursor-pointer w-full p-4 rounded-md bg-white/10 ease-in hover:border border-white/15 duration-300 transition-all shadow-md hover:shadow-violet-400 overflow-hidden">
